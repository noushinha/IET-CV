...
spec_dir = os.path.join(base_dir, Dataset, base1, "0_AudioVideo")
face_dir = os.path.join(base_dir, Dataset, base1, "0_AudioVideo")
#
# test_spec_filename = "eNTERFACE_predicted_probs_audio_feature_svm_unbiased.csv"
# test_face_filename = "eNTERFACE_predicted_probs_video_feature_svm_unbiased.csv"

# test_spec_filename = "eNTERFACE_predicted_probs_audio_feature_svm_biased.csv"
# test_face_filename = "eNTERFACE_predicted_probs_video_feature_svm_biased.csv"

# spec_dir = os.path.join(base_dir, Dataset, base2, "0_AudioVideo")
# face_dir = os.path.join(base_dir, Dataset, base1, face, "0.61", csv)
# #
# test_spec_filename = "eNTERFACE_predicted_probs_audio_feature_svm_unbiased.csv"
# test_face_filename = "Test_Face_Probabilities_360_Epochs.csv"
# 
spec_dir = os.path.join(base_dir, Dataset, base2, spec, "0.49", csv)
face_dir= os.path.join(base_dir, Dataset, base1, "0_AudioVideo")

test_spec_filename = "Test_Spec_Probabilities_110_Epochs.csv"
test_face_filename = "eNTERFACE_predicted_probs_video_feature_svm_unbiased.csv"
...
filename = os.path.join(save_dir, Dataset + "_non-normalized_confusion_matrix_svm_max_rule_video_unbiased_audio_cnn.eps")
...
filename = os.path.join(save_dir, Dataset + "_normalized_confusion_matrix_svm_max_rule_video_unbiased_audio_cnn.eps")
plt.savefig(filename, format='eps', dpi=1000, bbox_inches="tight")
# plt.show( block=True)
...
save_csv(conf_matrix, Dataset + "_non-normalized_confusion_matrix_svm_max_rule_video_unbiased_audio_cnn", save_dir)
save_csv(conf_matrix2, Dataset + "_normalized_confusion_matrix_svm_max_rule_video_unbiased_audio_cnn", save_dir)
save_csv(labels, Dataset + "_predicted_labels_sum_rule", save_dir)
HyperParameter_Setting = save_settings()
with open(os.path.join(save_dir, Dataset + "_results_svm_max_rule_video_unbiased_audio_cnn.txt"), "w") as text_file:
