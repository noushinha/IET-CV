...
filename = os.path.join(save_dir, Dataset + "_non-normalized_confusion_matrix_audio_feature_svm_unbiased1.eps")
...
filename = os.path.join(save_dir, Dataset + "_normalized_confusion_matrix_audio_feature_svm_unbiased1.eps")
plt.savefig(filename, format='eps', dpi=1000, bbox_inches="tight")
...
save_csv(y_probs, Dataset + "_predicted_probs_audio_feature_svm_unbiased1", save_dir)
...
im = heatmap(conf_matrix11, class_names, class_names, ax=ax, cmap="binary")
texts = annotate_heatmap(im, valfmt="{x:.0f}")
filename = os.path.join(save_dir, Dataset + "_non-normalized_confusion_matrix_video_feature_svm_unbiased1.eps")
plt.savefig(filename, format='eps', dpi=1000, bbox_inches="tight")
...
im = heatmap(conf_matrix12, class_names, class_names, ax=ax, cmap="binary")
texts = annotate_heatmap(im, valfmt="{x:.2f}")
filename = os.path.join(save_dir, Dataset + "_normalized_confusion_matrix_video_feature_svm_unbiased1.eps")
plt.savefig(filename, format='eps', dpi=1000, bbox_inches="tight")
...
print(conf_matrix12)
average_acc1 = np.average(conf_matrix12.diagonal())
save_csv(y_probs, Dataset + "_predicted_probs_video_feature_svm_unbiased1", save_dir)
...
im = heatmap(conf_matrix21, class_names, class_names, ax=ax, cmap="binary")
texts = annotate_heatmap(im, valfmt="{x:.0f}")
filename = os.path.join(save_dir, Dataset + "_non-normalized_confusion_matrix_video_feature_svm_biased1.eps")
plt.savefig(filename, format='eps', dpi=1000, bbox_inches="tight")
...
im = heatmap(conf_matrix22, class_names, class_names, ax=ax, cmap="binary")
texts = annotate_heatmap(im, valfmt="{x:.2f}")
filename = os.path.join(save_dir, Dataset + "_normalized_confusion_matrix_video_feature_svm_biased1.eps")
plt.savefig(filename, format='eps', dpi=1000, bbox_inches="tight")
