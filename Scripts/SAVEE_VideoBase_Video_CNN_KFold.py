...
base_dir   = "/media/Data/IEEE Transaction on Affective Computing/Data/" + Dataset + "/VideoBase/Video/Train_Test"
res_dir    = "/media/Data/IEEE Transaction on Affective Computing/Result/" + Dataset + "/VideoBase/Video/"
...
shutil.copyfile(os.path.join(file_path, Dataset + "_VideoBase_Video_CNN_KFold.py"), os.path.join(cur_res_dir, Dataset + "_VideoBase_Video_CNN_KFold.txt"))
plt.show(block=True)